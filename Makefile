...
CC = gcc
CPPFLAGS = -I. -I$(INCLUDEDIR) -I/root/include -I/usr/local/include -DNDEBUG -D_GNU_SOURCE=1 -D_REENTRANT -D__EXTENSIONS__ \
...
CFLAGS = -g -O2 -std=gnu99 -Wall -fPIC -fsigned-char -O2
